...
class CamposFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'cartao_id_idx' => ['type' => 'index', 'columns' => ['cartao_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'cartao_id' => ['type' => 'foreign', 'columns' => ['cartao_id'], 'references' => ['cartoes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
